...
import { ReactComponent as DropDownIcon } from "public/assets/dropdownIcon.svg";
...
const Container = styled.div<{ open: boolean }>`
	...
	border-bottom-left-radius: ${(props) => (props.open ? "0px" : "3px")};
	border-bottom-right-radius: ${(props) => (props.open ? "0px" : "3px")};
...
const DropDownItem = styled.div<{ selected: boolean }>`
	...
	color: ${(props) => (props.selected ? "#F06735" : "#86878a")};
